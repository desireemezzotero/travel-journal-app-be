...
<div class="container max-w-4xl mx-auto p-4 sm:grid sm:grid-cols-2 sm:gap-6 ">
  ...
  <div >
    <table class="table-auto">
      ...
      <tr class="border-b">
          <td class="font-semibold py-2 px-4">mood</td>
          @foreach($post->moods as $mood)
           <td class="py-2 px-4"> {{ $mood->title }} </td>
           @endforeach
        </tr>
        ...
        @auth
           ...
           <tr class="border-b">
             ...
             <td class="py-2 px-[100px] flex "> 
               <a href="#">
                 <svg class="w-[30px] text-black hover:scale-150 transition-transform duration-300" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
